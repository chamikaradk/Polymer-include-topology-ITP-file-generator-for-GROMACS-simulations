...
# INPUTS 
repeats = 3 #n'mer polymer, extendng from left to right ....
...
linkeralup = [162, Z, Hook_Z, 1, 132.100, 585.760] #left up
linkeraldown = [161, Z, Hook_Z, 1, 132.100, 585.760] #left down
linkerarup = [28, Hook_Z, Z, 1, 120.000, 527.184 ] #right up
linkerardown = [31, Hook_Z, Z, 1, 120.730, 537.811] #right down
...
with open('trimer.itp', 'w+') as file:
        for line in allines:
